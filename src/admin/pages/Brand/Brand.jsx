...
const Brand = () => {
  ...
  const changeStatus = async (data) => {
    ...
    if (res.status) {
      ...
      getListFun();
      toastifySuccess(
        `Brand set as ${data.status === 0 ? "Publish" : "Inactive"}`
      );
      setLoading(false);
    } else if (res?.error?.slug?.length > 0) {
      toastifyError(res?.error?.slug[0]);
  ...
  return (
    <>
      <div className="content-wrapper">
        ...
        <h4 class="py-3 mb-2"><span class="fw-light">Aksvedas /</span>Product Brands</h4>
              ...
              <div className="p-3">
                <div className="row justify-content-between">
                  <div className="col-md-6">
                    {/* <div className="d-flex justify-content-between align-items-center">
                      <h6 style={{ fontSize: "20px" }} class=" border-0  mb-0">
                        Brand
                      </h6>
                    </div> */}
                  </div>
      ...
      >
        ...
        <div className="offcanvas-body">
          <form
            ...
            onSubmit={updData ? handleUpdate : handleSubmit}
          >
            {/* Title */}
            <div className="mb-3">
