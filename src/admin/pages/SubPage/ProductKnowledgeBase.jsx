...
const ProductKnowledgeBase = () => {
    ...
    const getDataFun = async () => {
        try {
            setLoading(true);
            const res = await APICALL("get-ayurved-experience/product-knowledge-base");
            if (res?.status) {
                setList(res?.data);
                setLoading(false);
            } else {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(validationErrors).length === 0) {
            ...
            formData.append("type", 'product-knowledge-base');
            if(value?.id){
                                        ...
                                        <>
                                            {
                                                list?.map((item, i) => (
                                                    <div className="section_images">
                                                        <h4 className="d-flex align-items-center justify-content-between">{item?.title}
                                                            <div>
                                                        ...
                                                        <div className="row">
                                                            <div className="col-sm-6">
                                                                <div className="images_list">
                                                                    <img src={imgBaseURL() + item?.img1} alt="" className="w-100" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
