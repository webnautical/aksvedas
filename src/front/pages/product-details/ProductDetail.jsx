...
const ProductDetail = () => {
  ...
  const cartItem = cartData.find(
    (cartItem) => cartItem?.product_id == productDetails?.id
  );
    ...
    try {
      ...
      if (res?.status) {
        ...
        setProductPrice({
          ...
          sale_price: res?.data?.details?.sale_price,
        });
        ...
        if (res?.data?.details?.product_images?.length > 0) {
          ...
          if (res?.data?.details?.video) {
            images.push(imgBaseURL() + res?.data?.details?.video);
          }
  ...
  const checkCustomerAlreadyReviewGiven = () => {
    const res = reviewList.some(
      (item) => item.customer_id == authCustomer()?.id
    );
    return res;
  };
    ...
    if (res?.status === 200) {
      try {
        ...
        if (serviceabilityRes?.data?.status === 200) {
          setEstimatedInfo(
            serviceabilityRes?.data?.data?.available_courier_companies[0].etd
          );
        } else {
  ...
  const fullFileCheck =
    currentImage.endsWith(".mp4") || currentImage.endsWith(".mov");
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (productButton) {
        ...
        setShowStickyBar(rect.bottom < 0); // Jab buttons scroll se hide ho jayein, tab sticky bar dikhayein
      }
    };
          ...
          <div className="product-details">
            <div className="container">
              {productDetails?.h_one && (
                <h1 className="m-0 mt-3 mb-2" style={{ fontSize: "20px" }}>
                  {productDetails?.h_one}
                </h1>
              )}
              <Breadcrumbs
                     ...
                     <div className="skuno">
                            ...
                            <div className="col-lg-8 col-md-6">
                              <div className="select-plan">
                                ...
                                <div className="radio-options">
                                  {productDetails?.product_subscription?.map(
                                    (item, i) => (
                                      <label className="custom-radio w-100">
                                        ...
                                        {item?.days} Days ₹{item?.sale_price}@
                                        {item?.discount}% off
                                      </label>
                                    )
                                  )}
                          ...
                          >
                            <div className="container p-0">
                              <div class="my_sticky_bar">
                                ...
                                {productDetails?.quantity > 0 ? (
                                  <div className="doble_btn-pro d-flex gap-2">
                                    <button
                                      className="btn-2 text-nowrap w-100"
                                      onClick={() => addToCartFun("cart")}
                                      disabled={disabledBtn}
                                    >
                                      Add To cart{" "}
                                    ...
                                    {/* <button
                                      className="btn-2 buy-btn text-nowrap"
                                      onClick={() => addToCartFun("buy")}
                                    >
                                      Buy Now
                                    </button> */}
                        ...
                        <div className="delivery-datecheck">
                          ...
                          <div className="subscribe-date mb-0">
                            ...
                            <div className="submit">
                              <button
                                ...
                                disabled={deliveryPostelCode.length === 0}
                              >
                                Check
                              </button>
                            </div>
                          ...
                          <p className="bold-fre-deli mt-2 mb-4">
                            {estimatedInfo &&
                              "Expected delivery date : " + estimatedInfo}
                          </p>
                        </div>
                    ...
                    <div className="contact-us-inner p-0">
                      ...
                      <div className="row">
                        ...
                        <div className="mb-3 col-sm-12">
                          ...
                          <span>
                            {maxLength - reviewVal.review.length} characters
                            remaining
                          </span>
                        </div>
                ...
                <div className="col-lg-8">
                  ...
                  <div className="reviews-members">
                    {reviewList?.length > 0 ? (
                      reviewList
                        ?.slice(
                          0,
                          showAll ? reviewList.length : maxVisibleReviews
                        )
                        .map((item, i) => (
                  ...
                  {reviewList?.length > maxVisibleReviews && (
                    <div className="text-center">
                      {showAll ? (
                        <button className="btn-2 px-5" onClick={toggleShowAll}>
                          View Less
                        </button>
                      ) : (
                        <button className="btn-2 px-5" onClick={toggleShowAll}>
